/*
Deployment script for PWC_LayoutProcessing

This code was generated by a Visual Studio Database Publish tool.
Changes to this file may cause incorrect behavior and will be lost if
the code is regenerated.
*/

/*
This code uses the SQL files in the project and the post-deployment steps to build a database design (New).
Then it compares the database schema with that on target destination (Old) to generate the following script such that the (Old) can be altered to achieve (New).
This script can be executed as part of the deployment process to push changes to the target database
*/
